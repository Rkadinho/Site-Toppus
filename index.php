...
class="close" title="Close Modal">&times;</span> -->
  ...
  <!-- futura pagina de login -->
      ...
      <br>
      <!-- Carousel de noticias/slides -->
      <div id="myCarousel" class="carousel slide" data-ride="carousel" style="width:40%; left:30%">
          <!-- Indicadores -->
          ...
          <div class="carousel-inner" role="listbox">
            ...
            <div class="item active">
              <a href="ToppusOdonto.php"> <img src="Dental.jpg" alt="Image" ></a>    
            </div>
            <!-- slide 2 -->
            <div class="item">
              <a href="AniversarianteJan.php"><img src="AniJaneiro.jpeg" alt="Image"></a>
            </div>
            <!-- slide 3 -->
            <div class="item">
              <img src="JanBranco.jpeg" alt="Image" >     
            </div>
          </div>
      
          <!-- controle de direita e esquerda para passar o slide -->
          <!-- botão esquerda/voltar-->
          <a class="left carousel-control" href="#myCarousel" role="button" data-slide="prev">
            <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
            <span class="sr-only">Voltar</span>
          </a>
          <!-- botão direita/proximo -->
      ...
      <button id="button" style="position:absolute;width:20%;left:80%;bottom:70%;background-color: rgb(0, 110, 255);border-radius: 4px;">
