...
class="close" title="Close Modal">&times;</span> -->
  ...
  <!-- futura pagina de login -->
      ...
      <img src="Dental2.jpg" style="width:20%;position:relative;left:38%;">
      <h4 style="text-align: center;">
          A Toppus em parceria com a Odonto System, vem convidar todos os colaboradores do administrativo, para serem atendidos no 
          Carro Móvel in COMPANY, <br>sendo possível
          a realização da prevenção dentaria.<br><br>
          Essa ação ocorrerá na Segunda feira dia 11/01/2021, <br>no horário das 09:00 as 15:00 horas em frente a Unidade Toppus.<br>
          <br>
      </h4>
      <h4 style="text-indent:1%;">
          Regras:<ul>
              <li>é necessário o agendamento com o funcionário da Odonto System, no dia da ação;</li>
              <li>Possuir o plano Dentário;</li>
              <li>Caso deseje a adesão, pode ser realizada na hora, permitindo o atendimento no Carro Móvel;</li>
              <li>Obrigatório o uso de máscara.</li>
          </ul>
      </h4>
              <!-- imagens e noticias -->
        ...
        <div class="row">
          <div class="col-sm-4" style="border: 4px solid rgb(0, 110, 255); right: 1%;">
            ...
            <a href="index.php"><img src="JanBranco.jpeg" class="img-responsive" style="width:100%;" alt="Image"></a>
          </div>
          <!-- segunda imagem e noticia -->
          <div class="col-sm-4" style="border: 4px solid rgb(0, 110, 255);"> 
            <a href="AniversarianteJan.php"><img src="AniJaneiro.jpeg" class="img-responsive" style="width:100%" alt="Image"></a>  
          </div>
          <!-- terceira noticia -->
          <div class="col-sm-4">
